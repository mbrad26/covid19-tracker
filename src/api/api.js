...
export const NEWS_URL = `https://newsapi.org/v2/everything?q=covid-19&from=${date}&to=${date}&sources=,associated-press,bbc-news,cnn&apiKey=${process.env.REACT_APP_NEWS_TOKEN}`;
